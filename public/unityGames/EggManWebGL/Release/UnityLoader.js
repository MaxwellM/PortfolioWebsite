...
function LoadJSCode(e, t) {
    if (!Math.fround) {
        ...
        }, o = ["EMSCRIPTEN_START_ASM", "EMSCRIPTEN_START_FUNCS", "EMSCRIPTEN_END_FUNCS"], i = "var", a = "global.Math.fround;", r = 0, s = n.LOOKING_FOR_MODULE, d = 0, l = 0; s <= n.SCANNING_MODULE_FUNCTIONS && r < e.length; r++) if (47 == e[r] && 47 == e[r + 1] && 32 == e[r + 2] && String.fromCharCode.apply(null, e.subarray(r + 3, r + 3 + o[s].length)) === o[s]) s++; else if (s != n.SCANNING_MODULE_VARIABLES || l || 61 != e[r] || String.fromCharCode.apply(null, e.subarray(r + 1, r + 1 + a.length)) !== a) {
            if (l && 40 == e[r]) {
                for (var u = 0; l > u && e[r - 1 - u] == e[d - u];) u++;
                if (u == l) {
                    var c = e[r - 1 - u];
                    if (36 > c || c > 36 && 48 > c || c > 57 && 65 > c || c > 90 && 95 > c || c > 95 && 97 > c || c > 122) for (; u; u--) e[r - u] = 32
                }
            }
        } else {
...
function DecompressAndLoadFile(e, t, n) {
    ...
    o.open("GET", e, !0), o.onprogress = n, o.responseType = "arraybuffer", o.onload = function () {
        var n = new Uint8Array(o.response), i = (new Date).getTime(), a = pako.inflate(n), r = (new Date).getTime();
    ...
    return function e(t, n, o) {
        ...
        2: [function (e, t, n) {
            ...
            d[254] = d[254] = 1, n.string2buf = function (e) {
                ...
                var n, i, a, r, s = t || e.length, l = new Array(2 * s);
                for (i = 0, n = 0; s > n;) if (a = e[n++], 128 > a) l[i++] = a; else if (r = d[a], r > 4) l[i++] = 65533, n += r - 1; else {
        ...
        7: [function (e, t, n) {
            ...
            t.exports = function (e, t) {
                var n, a, r, s, d, l, u, c, f, h, p, m, b, w, g, v, k, y, _, S, x, M, C, E, D;
                n = e.state, a = e.next_in, E = e.input, r = a + (e.avail_in - 5), s = e.next_out, D = e.output, d = s - (t - e.avail_out), l = s + (e.avail_out - 257), u = n.dmax, c = n.wsize, f = n.whave, h = n.wnext, p = n.window, m = n.hold, b = n.bits, w = n.lencode, g = n.distcode, v = (1 << n.lenbits) - 1, k = (1 << n.distbits) - 1;
                e:do {
                    15 > b && (m += E[a++] << b, b += 8, m += E[a++] << b, b += 8), y = w[m & v];
                    t:for (; ;) {
                        if (_ = y >>> 24, m >>>= _, b -= _, _ = y >>> 16 & 255, 0 === _) D[s++] = 65535 & y; else {
                            ...
                            S = 65535 & y, _ &= 15, _ && (_ > b && (m += E[a++] << b, b += 8), S += m & (1 << _) - 1, m >>>= _, b -= _), 15 > b && (m += E[a++] << b, b += 8, m += E[a++] << b, b += 8), y = g[m & k];
                            n:for (; ;) {
                                ...
                                if (x = 65535 & y, _ &= 15, _ > b && (m += E[a++] << b, b += 8, _ > b && (m += E[a++] << b, b += 8)), x += m & (1 << _) - 1, x > u) {
                ...
                S = b >> 3, a -= S, b -= S << 3, m &= (1 << b) - 1, e.next_in = a, e.next_out = s, e.avail_in = r > a ? 5 + (r - a) : 5 - (a - r), e.avail_out = l > s ? 257 + (l - s) : 257 - (s - l), n.hold = m, n.bits = b
            }
        }, {}],
        8: [function (e, t, n) {
            "use strict";
            ...
            function s(e, t) {
                var n, o;
                return e && e.state ? (o = e.state, 0 > t ? (n = 0, t = -t) : (n = (t >> 4) + 1, 48 > t && (t &= 15)), t && (8 > t || t > 15) ? L : (null !== o.window && o.wbits !== t && (o.window = null), o.wrap = n, o.wbits = t, r(e))) : L
            }
            ...
            function c(e, t, n, o) {
                var i, a = e.state;
                return null === a.window && (a.wsize = 1 << a.wbits, a.wnext = 0, a.whave = 0, a.window = new w.Buf8(a.wsize)), o >= a.wsize ? (w.arraySet(a.window, t, n - a.wsize, a.wsize, 0), a.wnext = 0, a.whave = a.wsize) : (i = a.wsize - a.wnext, i > o && (i = o), w.arraySet(a.window, t, n - o, i, a.wnext), o -= i, o ? (w.arraySet(a.window, t, n - o, o, 0), a.wnext = o, a.whave = a.wsize) : (a.wnext += i, a.wnext === a.wsize && (a.wnext = 0), a.whave < a.wsize && (a.whave += i))), 0
            }

            function f(e, t) {
                var n, i, a, r, s, d, l, f, h, p, m, b, pe, me, be, we, ge, ve, ke, ye, _e, Se, xe, Me, Ce = 0,
                ...
                e:for (; ;) switch (n.mode) {
                    ...
                    case P:
                        ...
                        n.mode = Z;
                    case Z:
                        if (1024 & n.flags && (b = n.length, b > d && (b = d), b && (n.head && (_e = n.head.extra_len - n.length, n.head.extra || (n.head.extra = new Array(n.head.extra_len)), w.arraySet(n.head.extra, i, r, b, _e)), 512 & n.flags && (n.check = v(n.check, i, b, r)), d -= b, r += b, n.length -= b), n.length)) break e;
                        n.length = 0, n.mode = G;
                    case G:
                        if (2048 & n.flags) {
                            if (0 === d) break e;
                            b = 0;
                            do _e = i[r + b++], n.head && _e && n.length < 65536 && (n.head.name += String.fromCharCode(_e)); while (_e && d > b);
                            if (512 & n.flags && (n.check = v(n.check, i, b, r)), d -= b, r += b, _e) break e
                    ...
                    case q:
                        if (4096 & n.flags) {
                            if (0 === d) break e;
                            b = 0;
                            do _e = i[r + b++], n.head && _e && n.length < 65536 && (n.head.comment += String.fromCharCode(_e)); while (_e && d > b);
                            if (512 & n.flags && (n.check = v(n.check, i, b, r)), d -= b, r += b, _e) break e
                    ...
                    case W:
                        if (0 === n.havedict) return e.next_out = s, e.avail_out = l, e.next_in = r, e.avail_in = d, n.hold = f, n.bits = h, A;
                    ...
                    case V:
                        if (b = n.length) {
                            ...
                            w.arraySet(a, i, r, b, s), d -= b, r += b, l -= b, s += b, n.length -= b;
                            break
                        }
                        n.mode = J;
                        break;
                    ...
                    case re:
                        ...
                        } else me = a, pe = s - n.offset, b = n.length;
                        b > l && (b = l), l -= b, n.length -= b;
                        do a[s++] = me[pe++]; while (--b);
            ...
            var m, b, w = e("../utils/common"), g = e("./adler32"), v = e("./crc32"), k = e("./inffast"),
                ...
                ae = 24, re = 25, se = 26, de = 27, le = 28, ue = 29, ce = 30, fe = 31, he = 32, pe = 852, me = 592,
                be = 15, we = be, ge = !0;
        ...
        9: [function (e, t, n) {
            "use strict";
            var o = e("../utils/common"), i = 15, a = 852, r = 592, s = 0, d = 1, l = 2,
            ...
            t.exports = function (e, t, n, p, m, b, w, g) {
                ...
                if (e === s ? (T = q = w, x = 19) : e === d ? (T = u, P -= 257, q = c, j -= 257, x = 256) : (T = f, q = h, x = -1), z = 0, A = 0, R = L, S = b, B = F, O = 0, y = -1, N = 1 << F, _ = N - 1, e === d && N > a || e === l && N > r) return 1;
                for (var H = 0; ;) {
        ...
        "/lib/inflate.js": [function (e, t, n) {
            ...
            var a = e("./zlib/inflate.js"), r = e("./utils/common"), s = e("./utils/strings"),
...
"undefined" == typeof Module && (Module = eval("(function() { try { return Module || {} } catch(e) { return {} } })()")), Module.expectedDataFileDownloads || (Module.expectedDataFileDownloads = 0, Module.finishedDataFileDownloads = 0), Module.expectedDataFileDownloads++, function () {
    var e = function (e) {
        ...
        function n() {
            ...
            function l(e, t, n, o) {
                var i = e.transaction([v], m), a = i.objectStore(v), r = a.get(t);
            ...
            function u(e, t, n, o) {
                var i = e.transaction([k], m), a = i.objectStore(k), r = a.get(t);
                r.onsuccess = function (e) {
                    var t = e.target.result;
                    n(t)
                }, r.onerror = function (e) {
            ...
            function c(e, t, n, o, i, a) {
                var r = e.transaction([k, v], b), s = r.objectStore(k), d = r.objectStore(v), l = s.put(n, t);
            ...
            }, new n(0, 52572225, 0, 0).open("GET", "/data.unity3d"), new n(52572225, 52572246, 0, 0).open("GET", "/methods_pointedto_by_uievents.xml"), new n(52572246, 52582232, 0, 0).open("GET", "/preserved_derived_types.xml"), new n(52582232, 54556068, 0, 0).open("GET", "/Il2CppData/Metadata/global-metadata.dat"), new n(54556068, 55431040, 0, 0).open("GET", "/Resources/unity_default_resources"), new n(55431040, 55458665, 0, 0).open("GET", "/Managed/mono/2.0/machine.config");
            ...
            Module.addRunDependency("datafile_EggMan WebGL.data"), Module.preloadResults || (Module.preloadResults = {}), a(function (e) {
                l(e, o + i, function (t) {
                    Module.preloadResults[i] = {fromCache: t}, t ? (console.info("loading " + i + " from cache"), u(e, o + i, f, h)) : (console.info("loading " + i + " from remote"), fetchRemotePackageWrapper(r, s, function (t) {
        ...
        var i = "EggMan WebGL.data", a = "EggMan WebGL.data";
        ...
        var r = "function" == typeof Module.locateFile ? Module.locateFile(a) : (Module.filePackagePrefixURL || "") + a,
            s = 55458665, d = "94ee0ae1-9a4b-45b4-8896-9134b739acec";
